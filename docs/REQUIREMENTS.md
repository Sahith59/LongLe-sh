...
| **The daemon is running** | It is the thing your phone talks to. | Recommended: install the per-user background service during `longleash setup`. Foreground `longleash run` works only while that terminal remains open. |
